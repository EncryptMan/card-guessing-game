...
public:
    explicit InvalidCardException(const string& msg = "Invalid card operation")
        : GameException(msg) {}
};
...
public:
    explicit BoardInitializationException(const string& msg = "Board initialization failed")
        : GameException(msg) {}
};
...
public:
    explicit FileIOException(const string& msg = "File IO operation failed")
        : GameException(msg) {}
};
